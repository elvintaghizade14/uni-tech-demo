...
public final class CustomConditions {
    ...
    public static ArchCondition<? super JavaField> haveGetter(Map<String, String> exclusions) {
            ...
            public void check(JavaClass javaClass, ConditionEvents events) {
                ...
                if (equalsMethod.isEmpty()) {
                    events.add(SimpleConditionEvent.violated(
                            javaClass, String.format(EQUALS_OR_HASH_CODE_NOT_PRESENT_ERROR_MESSAGE,
            ...
            public void check(JavaClass javaClass, ConditionEvents events) {
                javaClass.getMethods().stream()
                        ...
                        .forEach(m -> SimpleConditionEvent.violated(
                                javaClass, String.format("Static method %s in %s is not allowed",
                                        m.getName(), javaClass.getName())));
            }
        };
    }
